...
MyGame = ig.Game.extend({
	...
	update: function() {
        ...
        if(ig.input.state('Restart') && this.IsPlayerAlive === false) {
	...
	draw: function() {
		...
		if(this.IsStarted === false) {
            this.font.draw("Art By Kenney.nl", 20, ig.system.height - 30, ig.Font.ALIGN.LEFT);
        ...
        if(this.IsStarted === true && this.IsPlayerAlive === false) {
            this.font.draw("Press 'R' To Restart", ig.system.width / 2, ig.system.height / 2 - 20, ig.Font.ALIGN.CENTER);
