...
if(this.IsPlayerAlive===true&&this.IsStarted===true){for(i=0;i<this.rockArray.length;i++){this.rockArray[i].pos.x-=1;if(this.rockArray[i].pos.x<-150){this.rockArray[i].kill();this.rockArray.shift();}}}},draw:function(){this.parent();this.font.draw(this.PlayerScore,ig.system.width/2,20,ig.Font.ALIGN.CENTER);if(this.IsStarted===false){this.font.draw("Art By Kenny.nl",20,ig.system.height-30,ig.Font.ALIGN.LEFT);this.font.draw("@Jack_Hodgkiss",ig.system.width-20,ig.system.height-30,ig.Font.ALIGN.RIGHT);}
